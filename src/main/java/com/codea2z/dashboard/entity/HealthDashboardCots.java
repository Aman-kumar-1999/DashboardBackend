...
@Entity
@Table(name="Health_Dashboard_Cots")
public class HealthDashboardCots {
	
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO)
	private Long id;
	
	@Column(name="Dates_Time")
	...
	public HealthDashboardCots(Long id, LocalDate datetime, String healthDashboard, String applicationName,
